<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="mb-8 font-bold text-2xl md:text-3xl text-gray-800 dark:text-gray-100">Add New Student</div>
            ...
            <form action="{{ route('admin.students.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" name="password_confirmation" class="form-input w-full" type="password" required />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                                <input type="checkbox" id="course_{{ $course->id }}" name="courses[]" value="{{ $course->id }}" class="form-checkbox" {{ (is_array(old('courses')) && in_array($course->id, old('courses'))) ? 'checked' : '' }}>
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    ...
                    <button type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">Register Student</button>
                </div>
            </form>
        </div>
    </div>
